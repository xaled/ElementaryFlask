...
from flaskly.components import EmptyPageLayout, AbstractNavigation
...
class TopNavigationLayout(EmptyPageLayout):
    ...
    def render_body_tag(self, ns: SimpleNamespace) -> str:
        return jinja2_env.render_template('layouts/default_body.html', navigation=self.navigation, **ns.__dict__)
